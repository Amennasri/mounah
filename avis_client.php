...
if (!isset($_SESSION["id_user"])) {
	...
	$id_user = $_SESSION["id_user"]; // Récupère l'ID users de la session
}

// Requête pour récupérer le restaurant associé à l'users connecté
...
<body>
	<div class="container site">
		<h1 class="text-logo"><span class="glyphicon glyphicon-cutlery"></span> Menu <span class="glyphicon glyphicon-cutlery"></span></h1>
		<nav>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="tab44" role="tabpanel">
				<h2><strong>Liste des avis </strong></h2>
				...
				<a class="btn btn-warning" style="float:right" href="deconnexion.php" onclick="return confirmLogout()"><span class="glyphicon glyphicon-log-out"></span> Se déconnecter</a>
			</div>
		</div>
	</div>
